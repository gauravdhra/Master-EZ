        ...
        <div className="content">
                  ...
                  <Row>
                    ...
                    <Col xs="7">
                      <div className="numbers">
                        ...
                        <CardTitle tag="h1" className="number-label">6</CardTitle>
                      </div>
                    </Col>
                  </Row>
                </CardBody>
                  ...
                  <Row>
                    ...
                    <Col xs="7">
                      <div className="numbers">
                        ...
                        <CardTitle tag="h1" className="waittime-number-label">7 min</CardTitle>
                      </div>
                    </Col>
                  </Row>
                </CardBody>
            ...
            <Col lg="3" md="6">
              <Card className="card-stats">
                  ...
                  <Row>
                    ...
                    <Col xs="7">
                      <div className="numbers">
                        ...
                        <CardTitle tag="h1" className="completed-number-label">34</CardTitle>
                      </div>
                    </Col>
                  </Row>
                </CardBody>
                <CardFooter>
                  <hr />
                  <div className="stats">
                    <i className="tim-icons icon-trophy" /></div>
                </CardFooter>
              </Card>
            </Col>
            <Col lg="3" md="6">
              <Card className="card-stats">
                  ...
                  <Row>
                    ...
                    <Col xs="7">
                      <div className="numbers">
                        ...
                        <CardTitle tag="h1" className="provider-number-label">8</CardTitle>
                      </div>
                    </Col>
                  </Row>
                </CardBody>
                <CardFooter>
                  <hr />
                  <div className="stats">
                    <i className="tim-icons icon-watch-time" /></div>
                </CardFooter>
              </Card>
            </Col>
            {/* <Col lg="4">
          ...
          <Row>
              <Col lg="4">
                <Row>
                <Col lg="12">
                <Card className="card-chart mb-8">
                  <CardHeader>
                    <h5 className="card-category">Daily Sales</h5>
                      <CardTitle className="sales-card-title">
                ...
                <Col lg="12">
                  {/* <Col lg="4"> */}
                    <Card className="card-chart">
                      <CardHeader>
                        {/* <h5 className="card-category">Total Shipments</h5> */}
                      <CardTitle className="wait-card-title">
                          <i className="tim-icons icon-bell-55 text-primary" />{" "}
                          Wait Time Today
                  </CardTitle>
                      </CardHeader>
            ...
            <Col lg="8">
              <Card className="card set-height-equal">
                <CardHeader>
                  ...
                  {/* <Table responsive> */}
                    ...
                    <tbody>
                      <tr>
                        ...
                        <td className="text-right">2:21</td>
                      ...
                      <tr>
                        ...
                        <td className="text-right">2:23</td>
                        <td className="text-right">
                          <Button
                            className="btn-link btn-icon"
                            color="success"
                      ...
                      <tr>
                        ...
                        <td className="text-right">2:24</td>
                        <td className="text-right">
                          <Button
                            className="btn-link btn-icon"
                            color="success"
